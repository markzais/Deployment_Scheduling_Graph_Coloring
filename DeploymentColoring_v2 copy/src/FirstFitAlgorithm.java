...
public class FirstFitAlgorithm {
    ...
    public FirstFitAlgorithm(int[][] edges, int[][] locationTracker, int numDeployments, int locations, int[][]deploymentDates, int d){
...
//     printAssignments(colorAssignments);
     ...
     System.out.println("First-Fit Algorithm time: " + totalTime + " seconds");
    ...
    public static void printRatios(double[] solution) {
        for (int i = 0; i < solution.length; i++) {
            System.out.print(solution[i] + " ");
       System.out.println();
        }
